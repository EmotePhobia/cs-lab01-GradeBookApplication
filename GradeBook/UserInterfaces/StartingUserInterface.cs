    ...
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
           ...
           /* BaseGradeBook gradeBook = new BaseGradeBook(name);
            ...
            {
                Console.WriteLine("{2} is not a supported type of gradebook, please try again");
                return;
            }
        }
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("create\" command to write \"Create 'Name' 'Type' - Creates a new gradebook where 'Name' is the name of the gradebook and 'Type' is what type of grading it should use.");
            Console.WriteLine();
